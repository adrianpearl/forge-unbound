...
export function CampaignConfigForm({ initialConfig, onConfigChange, className = "" }: CampaignConfigFormProps) {
  ...
  return (
    <div className={`space-y-6 ${className}`}>
      ...
      {/* Branding */}
      <div className="space-y-4">
        <h4 className="font-medium text-sm text-muted-foreground uppercase tracking-wide">Branding</h4>
      ...
      {/* Page Content */}
      <div className="space-y-4">
        <h4 className="font-medium text-sm text-muted-foreground uppercase tracking-wide">Page Content</h4>
      ...
      {/* Legal & Donation Settings */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-4">
          <h4 className="font-medium text-sm text-muted-foreground uppercase tracking-wide">Legal Information</h4>
        ...
        <div className="space-y-4">
          <h4 className="font-medium text-sm text-muted-foreground uppercase tracking-wide">Donation Settings</h4>
      ...
      {/* Custom Messages */}
      <div className="space-y-4">
        <h4 className="font-medium text-sm text-muted-foreground uppercase tracking-wide">Custom Messages</h4>
